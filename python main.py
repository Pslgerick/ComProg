...
class calc:
	...
	def __init__(self,master):
			...
			# Operation Buttons
			btn_off=Button(master,text="OFF",width=8,height=2, fg="black",bg="SeaGreen2", command=quit)
			...
			num_00=Button(master,text="00",width=8,height=4, fg="black",bg="gray86", command=lambda:self.click("00"))
